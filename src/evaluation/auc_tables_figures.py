...
def create_AUC_matrix(home, x_col, y_col, augment, k, batch_size):
    ...
    source_datasets = ['isic', 'chest', 'pcam-middle', 'pcam-small', 'kimia']
...
def create_heatmap(mean_auc_dict, overall_ranking):
    ...
    ax.set_yticklabels(['ISIC2018', 'Chest X-rays', 'PCam-middle', 'PCam-small', 'KimiaPath960'])
...
def create_barplot(mean_auc_dict, std_auc_dict):
    ...
    source = ['ISIC2018', 'Chest X-rays', 'PCam-middle', 'PCam-small', 'KimiaPath960']
    ...
    colors = [(0.6509803921568628, 0.8470588235294118, 0.32941176470588235, 1.0),
